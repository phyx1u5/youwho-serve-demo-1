            ...
            <Box p={[0, 4, 6, 8]} minH="100%">
                <Container minHeight={["91vh", "200px", "200px", "200px"]} maxW="lg" borderRadius={["0", "xl", "xl", "xl"]} px={[4, 6, "", ""]} pb={[4, 6, "", ""]} pt={[1, 5, "", ""]} mb={["60px", "0", "", ""]} >
                    <Center mb={1} mr={1} color={grayText2}>
                        <Text fontWeight="400" fontSize="3xl" ml={1} color={grayText2}><Icon as={newEvent ? BiI.BiCommentError : BiI.BiCommentDetail} color={newEvent ? "red.400" : "primary.400"} mb={1} mr={2} />{newEvent ? "New Events" : "My Events"}</Text>
                        <Spacer />
        ...
        <>
            ...
            >
                ...
                <AlertDialogContent m={3} borderRadius="lg" className="bgBlurModal">
                    <AlertDialogHeader><Icon as={Io5.IoSaveOutline} w={6} h={6} mr={2} mb={1} />Save Changes</AlertDialogHeader>
