                    ...
                    : (
                        <>
                            ...
                            <Flex pt={2} pr={1} align="center">
                                ...
                                <Spacer />
                                <IconButton onClick={() => setDisableEdit(!disableEdit)} isActive={false} color={disableEdit ? "primary.400" : "yellow.400"} variant="unstyled" size="sm" mr={1} fontSize="24px" h="24px" w="24px" icon={<Io5.IoHammerOutline />} />
                            ...
                            <Box py={2}>
                                ...
                                <Flex px={2} >
                                    <Text textAlign="left" color={disableEdit ? "inherit" : "primary.400"} fontWeight="400" fontSize="24px" ><Icon as={HiI.HiOutlinePencilAlt} fontSize="22px" color="secondary.200" mb={1} mr={2} />{title}</Text>
                                </Flex>
        ...
        <>
            ...
            <AlertDialog motionPreset="slideInBottom" leastDestructiveRef={cancelRef} onClose={onClose} isOpen={isOpen} isCentered >
                ...
                <AlertDialogContent m={3} borderRadius="lg" p={2} className="bgBlurModal" >
                    <AlertDialogHeader p={4}><Icon as={Io5.IoTrashBinOutline} color="red.300" w={6} h={6} mr={2} mb={1} />Confirm Delete Service</AlertDialogHeader>
        ...
        <>
            ...
            <Modal isOpen={isOpen} size="lg" onClose={postSuccess ? () => { onClose(); window.scrollTo(0, 0); window.location.reload(); } : () => { onClose(); setOkToPreview(false); setOkToPost(true); }} >
                ...
                <ModalContent minHeight="200px" m={3} borderRadius="xl" p={2} mx={3} mt="10%" className="bgBlurModal" >
                    {postSuccess ? (
                        <>
                            <ModalHeader p={4} fontWeight="400"><Icon as={Io5.IoBonfireOutline} color="secondary.300" mb={1} mr={1} h="24px" w="24px" />Update Success!</ModalHeader>
                        ...
                        <>
                            <ModalHeader p={4} fontWeight="400"><Icon as={HiI.HiOutlineBadgeCheck} color="primary.300" mb={1} mr={1} h="24px" w="24px" />Confirm Changes</ModalHeader>
