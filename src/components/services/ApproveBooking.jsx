            ...
            {siteIsLoading ?
                ...
                <>
                    <Flex mb={3} mr={1} color={grayText2} align="center">
                        <Text fontWeight="400" fontSize="3xl" ml={1}  ><Icon as={BsI.BsListCheck} color="yellow.400" mb={1} mr={2} />Approve Booking</Text>
                        <Spacer />
                    ...
                    <Modal isOpen={isOpen} size="lg" onClose={bookSuccess ? () => { onClose(); window.scrollTo(0, 0); window.location.reload(); } : () => { onClose(); }} >
                        ...
                        <ModalContent minHeight="200px" borderRadius="xl" p={2} mx={3} mt="10%">
                            {bookSuccess ?
                                <>
                                    <ModalHeader p={4} fontWeight="400"><Icon as={FaI.FaRegHandSpock} color="secondary.300" mb={1} mr={1} h="24px" w="24px" />Confirm Payment</ModalHeader>
                                ...
                                :
                                <>
                                    <ModalHeader p={4} fontWeight="400"><Icon as={HiI.HiOutlineBadgeCheck} color="primary.300" mb={1} mr={1} h="24px" w="24px" />Confirm Booking</ModalHeader>
