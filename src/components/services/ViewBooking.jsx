...
export default function ViewBooking({ grayText, grayText2, history, bookedService, bookingId, provider, rate, setRate, description, setDescription, selectedTimezone, user, showLightbox, lightboxArray, setShowLightbox, ethAddress, setEthAddress, bookingUser, setBookingUser, booking, setBooking, bookingPublic, setBookingPublic, bookingApproval, setBookingApproval, ethAddresses, setEthAddresses, bookingStatus, setBookingStatus, rateAgreed, setRateAgreed, durationHours, setDurationHours, serviceLocation, setServiceLocation, paidAmountUsd, setPaidAmountUsd, dayTime, setDayTime, amountUhu }) {
            ...
            {siteIsLoading ?
                ...
                <>
                    <Flex mb={3} mr={1} color={grayText2} align="center">
                        <Text fontWeight="400" fontSize="3xl" ml={1} color={bookingStatus === "declined" ? "crimson" : "inherit"} ><Icon as={TiI.TiBookmark} color="yellow.400" mb={1} mr={2} />My Booking</Text>
                        <Spacer />
                    ...
                    <Stack spacing="6">
                        ...
                        {(bookingStatus === "paid" && !siteIsLoading && amountUhu) && <SuccessBox status={`success`} title={`Congratulations!`} message={<>You earned <b>{Number(amountUhu / 10 ** 18).toFixed(4)} UHU</b> Tokens as our way of saying Thank you!</>} setUpdateSuccess={() => { }} />}
                            ...
                            <Center w="100%" justify="space-between" align="center">
                                {!user ?
                                    ...
                                    bookingStatus === "pending" ?
                                        <>
                                            <Box px={2}>
                                                <Text color="yellow.400" lineHeight="22px" fontSize={["lg", "xl", "2xl", ""]} fontWeight="300"><Icon as={Io4.IoIosTimer} mb="2px" mr={1} />Awaiting Approval</Text>
                                            </Box>
                                        </>
                                        :
