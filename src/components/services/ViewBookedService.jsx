            ...
            {siteIsLoading ?
                ...
                <>
                    <Flex mb={3} mr={1} color={grayText2} align="center">
                        <Text fontWeight="400" fontSize="3xl" ml={1} color={bookingStatus === "declined" ? "crimson" : "inherit"} ><Icon as={TiI.TiBookmark} color="teal.300" mb={1} mr={2} />Users Booking</Text>
                        <Spacer />
                    ...
                    <Stack spacing="6">
                        ...
                        {(bookingStatus === "paid" && claimableAmount > 0) && <SuccessBox status={`success`} title={`Booking Paid`} message={<>The User has paid for this booking. You are eligble to claim <b>{Number(claimableAmount / 10 ** 18).toFixed(4)} UHU</b> tokens. Click the Review User button below to review the User and claim your tokens!</>} setUpdateSuccess={() => { }} />}
                                ...
                                {bookingStatus === "pending" ?
                                    disableEdit ?
                                        <>
                                            ...
                                            <Spacer />
                                            <Button color="yellow.600" bg="yellow.200" _hover={{ bg: "yellow.300" }} _focus={{ bg: "yellow.200" }} _active={{ bg: "yellow.200" }} borderRadius="md" onClick={() => setDisableEdit(false)} ><Icon as={Io5.IoHammerOutline} w="24px" h="24px" mr={2} mt="1px" /> Edit</Button>
                                            <Spacer />
                                    ...
                                    bookingStatus === "approved" ?
                                        ...
                                        bookingStatus === "paid" ?
                                            <>
                                                ...
                                                <Spacer />
                                                {claimableAmount > 0 ?
                                                    <Button color="yellow.600" bg="yellow.200" _hover={{ bg: "yellow.300" }} _focus={{ bg: "yellow.200" }} _active={{ bg: "yellow.200" }} borderRadius="md" onClick={() => history.push(`/activity/who/bookings/${bookedId}/review`)} ><Icon as={BsI.BsListCheck} w="24px" h="24px" mr={2} mt="1px" /> Review User</Button>
                                                    :
        ...
        <>
            ...
            >
                ...
                <AlertDialogContent m={3} borderRadius="lg" className="bgBlurModal">
                    <AlertDialogHeader><Icon as={Io4.IoMdCheckmarkCircleOutline} color="primary.600" w={6} h={6} mr={2} mb={1} />Approve</AlertDialogHeader>
    ...
    return (
        <>
            ...
            >
                ...
                <AlertDialogContent m={3} borderRadius="lg" className="bgBlurModal">
                    <AlertDialogHeader><Icon as={FcI.FcCancel} w={6} h={6} mr={2} mb={1} />Decline Booking</AlertDialogHeader>
                    <AlertDialogCloseButton />
                    <AlertDialogBody>
