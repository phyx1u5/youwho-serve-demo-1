        ...
        <>
            ...
            <Modal initialFocusRef={initialRef} finalFocusRef={finalRef} isOpen={isOpen} onClose={onClose} >
                ...
                <ModalContent minHeight="200px" borderRadius="xl" p={2} mx={3} mt="10%" className="bgBlurModal" >
                    <ModalHeader p={4} fontWeight="400" fontSize="1em"><Icon as={AiI.AiOutlineExperiment} fontSize="1em" size="s" color="primary.400" mb={1} mr={1} h="24px" w="24px" />Filter Search Results</ModalHeader>
