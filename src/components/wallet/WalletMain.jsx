        ...
        return (
            <Stack spacing="4">
                <Box borderBottom="1px" pb={5} pt={3} borderColor="gray.10" >
                    ...
                    <Text as="a" target="_blank" href={`https://rinkeby.etherscan.io/address/${ethAddress}`} px={1} fontWeight="500" color={colorMode === "light" ? "primary.600" : "primary.200"}>{ethAddress}</Text>
                </Box>
                ...
                <Box borderBottom="1px" pb={5} borderColor="gray.10" >
                    ...
                    <Stack spacing="3" px={["0", "6", "", ""]}>
                        <Flex bg="gray.10" borderRadius="md" p={["2", "4", "", ""]} as="a" target="_blank" href={`https://rinkeby.etherscan.io/address/${ethAddress}`}>
                        ...
                        {userBalances.map((x, i) =>
                            <Flex bg="gray.10" key={i + "flex"} borderRadius="md" p={["2", "4", "", ""]} as="a" target="_blank" href={`https://rinkeby.etherscan.io/token/${x.attributes.token_address}?a=${ethAddress}`}>
