...
export default function Wallet() {
    ...
    useEffect(() => {
        ...
        // let acceptedCryptos = [{ "name": "YouWho", "ticker": "UHU", "address": "0xfDe24B1EaC568e2f963F026bEB494534E17741e4" }, { "name": "YouWho USD", "ticker": "UHUSD", "address": "0x7c875FCdf6728E16c51CFC542341110A9DD469cC" }]
        ...
        <Box w="100%" minH="100vh" minW="100vw" h="100%" p={0} bg={bg} border={0}>
            ...
            <Box p={[0, 4, 6, 8]} minH="100%">
                <Container minHeight={["91vh", "400px", "", ""]} maxW="lg" borderRadius={["0", "xl", "xl", "xl"]} px={[4, 6, "", ""]} pb={[4, 6, "", ""]} pt={[1, 5, "", ""]} mb={["60px", "0", "", ""]} >
                    ...
                    <Flex mb={3}>
                        <Text fontWeight="400" fontSize="3xl" ml={1} color={grayText2} ><Icon as={Io5.IoWalletOutline} color="yellow.400" mb={1} mr={2} />My Wallet</Text>
                    </Flex>
