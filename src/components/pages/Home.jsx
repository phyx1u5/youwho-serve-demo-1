...
export default function Home() {
    ...
    // const bgGradientLight = "radial-gradient(circle at 30vw 90vh, rgba(255,48,0,0.07) 0%, rgba(255,217,29,0.05) 50%, rgba(249,249,249,0.0) 100%)";
    // const bgGradientLight = "radial-gradient(circle at 30vw 90vh, rgba(255,217,29,0.05) 0%, rgba(255,48,0,0.07) 50%, rgba(249,249,249,0.0) 100%)";
            ...
            <Box p={[3, 4, 6, 8]} pt={["15%", "100px", "100px", "100px"]}>
                <Container minHeight="200px" maxW="lg" borderRadius="xl" p="0" overflow="hidden">
                    ...
                    <Stack px="5" pt="4" pb="8" align="center" >
                        ...
                        <Button onClick={user ? () => { setYouWhoSwitch(true); window.localStorage.setItem("youWhoSwitch", true); history.push("/activity/who"); } : onOpen} bg="red.100" _hover={{ bg: "red.200" }} _focus={{ bg: "red.100" }} _active={{ bg: "red.100" }} p="6">
