            ...
            <Box p={[0, 4, 6, 8]} minHeight="100%">
                <Container minHeight={["91vh", "200px", "200px", "200px"]} maxW="lg" borderRadius={["0", "xl", "xl", "xl"]} px={[4, 6, "", ""]} pb={[4, 6, "", ""]} pt={[1, 5, "", ""]} mb={["60px", "0", "", ""]} >
                    <Stack pb={2} spacing="0" >
                        ...
                        <Text fontWeight="400" fontSize="3xl" ml={1} color={grayText2}><Icon as={HiI.HiOutlinePencilAlt} color="secondary.200" mb={1} mr={2} />Post a New Service</Text>
        ...
        <>
            ...
            <Modal isOpen={isOpen} size="lg" onClose={postSuccess ? () => { onClose(); window.scrollTo(0, 0); window.location.reload(); } : () => { onClose(); setOkToPreview(false); setOkToPost(true); }} >
                ...
                <ModalContent minHeight="200px" borderRadius="xl" p={2} mx={3} mt="10%" className="bgBlurModal">
                    {postSuccess ? (
                        <>
                            <ModalHeader p={4} fontWeight="400"><Icon as={Io5.IoBonfireOutline} color="secondary.300" mb={1} mr={1} h="24px" w="24px" />Post Success!</ModalHeader>
                        ...
                        <>
                            <ModalHeader p={4} fontWeight="400"><Icon as={HiI.HiOutlineBadgeCheck} color="primary.400" mb={1} mr={1} h="24px" w="24px" />Confirm Post</ModalHeader>
